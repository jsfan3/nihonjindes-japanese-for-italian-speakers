...
<svelte:head>
	<meta property="og:title" content="Nihonjindes" />
	<meta
		property="og:description"
		content="Esercizi di giapponese per italiani (by Francesco Galgani)"
	/>
</svelte:head>

{#if isBrowser() !== true}
	<div class="pageloader is-active"><span class="title">Nihonjindes - Esercizi di giapponese per italiani (by Francesco Galgani)</span></div>
{/if}
